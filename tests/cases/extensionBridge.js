...
async function chay(so) {
  ...
  check(so, 'relay config va heartbeat chi gui sau khi sheetLink da bat tay', bootstrapSource.indexOf('sheetLinkInstall();') >= 0 && bootstrapSource.indexOf('fbmSyncConfigureRelay().then(function ()') > bootstrapSource.indexOf('sheetLinkInstall();') && syncSource.indexOf('CRM_FBM_HEARTBEAT_NOW') >= 0, true);
