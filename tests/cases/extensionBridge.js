...
function chay(so) {
  ...
  check(so, 'tu dien nhan dien FBM chi qua probe va xac nhan', syncSource.indexOf('function fbmSyncProbeIdentity()') >= 0 && syncSource.indexOf("callServer('fbmStartIdentityProbe')") >= 0 && syncSource.indexOf("callServer('fbmSaveIdentityBinding'") >= 0 && syncSource.indexOf('fbm-sync-confirm-identity') >= 0, true);
