...
async function chay(so) {
  ...
  check(so, 'Sidebar co man hinh giai quyet conflict theo hai phia', syncSource.indexOf('data-fbm-conflict-choice') >= 0 && syncSource.indexOf('fbmPrepareConflictResolution') >= 0 && syncSource.indexOf('fbmConfirmConflict') >= 0 && syncAuditSource.indexOf('Giữ toàn bộ ShinCRM') >= 0 && syncAuditSource.indexOf('Giữ toàn bộ FBM') >= 0 && syncAuditSource.indexOf('function fbmSyncConflictContentBlocks') >= 0, true);
