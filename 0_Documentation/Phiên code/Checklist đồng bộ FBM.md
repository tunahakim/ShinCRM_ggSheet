...
- [x] Tinh chỉnh khả năng đọc `Cài đặt phiên`: nhãn bốn tiến trình trở về cỡ chữ dùng chung và được phép xuống dòng; ô `Chiều đồng bộ` dùng flex để co giãn theo nhãn; test offline `1636/1636`.
