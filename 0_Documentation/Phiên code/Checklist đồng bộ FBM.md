...
- [x] Bổ sung kiểm thử offline cho compare, modal, save/discard lỗi, form lõi, FBM và password; khóa hồi quy discard phải chạy pending action và component modal không được hardcode HTML.
- [x] Chạy `node tests/run.js`: 1.713 phép đạt, 0 phép lỗi; đã cập nhật checklist riêng và cây thư mục code; test hợp đồng tĩnh đã khóa wiring; commit `bebeae3`, `b5d0a3a`, `4145a90`, `c7592fa`, `f6fb40b`.
