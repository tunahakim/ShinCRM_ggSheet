...
- [x] Tinh chỉnh bố cục `Cài đặt phiên`: công tắc lịch nền đứng trước chiều đồng bộ, cột chu kỳ bốn tiến trình rộng hơn và nhóm detail có nhãn `Tối thiểu/Tối đa`; test offline `1636/1636`.
