...
- [x] Menu ba chấm dùng cùng khung và option spacing với popup `Chiều đồng bộ`; chỉ giữ font và màu chữ/active/hover riêng của menu module; test offline `1585/1585`, commit `81fa5f5`, GAS DEV revision `@379`.
