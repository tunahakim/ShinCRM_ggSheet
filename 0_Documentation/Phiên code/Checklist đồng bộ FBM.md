...
- [x] Chạy `node tests/run.js`: 1.701 phép đạt, 0 phép lỗi; đã cập nhật checklist riêng và cây thư mục code; test hợp đồng tĩnh đã khóa wiring; commit `bebeae3`, `b5d0a3a`, `4145a90`.
