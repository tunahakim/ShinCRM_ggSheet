...
- [x] Tab `Kết quả & xử lý` hiển thị năm tab chỉ có nhãn; mô tả nằm ở một vùng riêng bên dưới hàng tab và được vá theo tab đang chọn, giữ mã tab và vá tại chỗ; dòng mô tả một dòng, chữ phụ 13px, khoảng cách dọc gọn; test offline `1589/1589`, commit `fa9c98c`, GAS DEV revision `@347`.
