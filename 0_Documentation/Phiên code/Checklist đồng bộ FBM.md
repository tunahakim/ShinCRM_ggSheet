...
- [x] Tab `Kết quả & xử lý` hiển thị đủ năm tab bằng item hai tầng (tên ngắn + mô tả), giữ mã tab và vá tại chỗ; test offline `1589/1589`, commit `1426851`, GAS DEV revision `@345`.
