...
- [x] GAS DEV relay `AKfycbxWM4...` đã nâng revision `@286`; entrypoint transport failure giữ fail-closed với reservation cũ và xác nhận lỗi capture hiện kết thúc tại `error`, không giữ cursor/reservation.
