...
- [x] Tab `Kết quả & xử lý` hiển thị năm tab chỉ có nhãn; mô tả nằm ở một vùng riêng bên dưới hàng tab và được vá theo tab đang chọn, giữ mã tab và vá tại chỗ; body dùng một section chung để các tab có cùng khoảng cách, chữ phụ 13px, Nghiệm thu tối đa hai dòng; test offline `1589/1589`.
