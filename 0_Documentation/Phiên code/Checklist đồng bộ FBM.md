...
| Slice 8 — UI + log + probe | `e243432`, `3e60e88`, `e4c92c1` | `1196/1196` | `@214` (`fbmGetMasterSwitch` trả `OK`, `enabled: true`) | UI shell bốn màn hình, menu dọc phù hợp Sidebar hẹp, pill `ON/OFF`, cụm phải `[ON/OFF] [☰]`, pipeline, tab kết quả và phân trang đã hoàn tất; card dùng renderer Block; chưa nghiệm thu probe trên Sidebar | Cần chủ dự án đóng/mở lại Sidebar để tải deployment mới và kiểm tra hiển thị thực tế |
