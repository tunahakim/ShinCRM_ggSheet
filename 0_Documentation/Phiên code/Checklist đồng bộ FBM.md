...
| Slice 8 — UI + log + probe | `e243432`, `3e60e88` | `1196/1196` | `@211` (GET master switch PASS; redeploy tiếp theo `@212` gặp HTTP 404) | UI shell bốn màn hình, công tắc tổng/lịch nền, pipeline, tab kết quả và phân trang đã hoàn tất; card dùng renderer Block; chưa nghiệm thu probe trên Sidebar | Cần chủ dự án kiểm tra hiển thị thực tế sau khi reload Extension/Sidebar |
