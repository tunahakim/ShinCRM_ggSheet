...
function fbmStartIdentityCheck(identity) { return runEntryPoint('fbmStartIdentityCheck', 'sidebar', 'throw', function () { return fbmPublicResult(FbmSync.controlDispatchLocked('start', { mode: 'check', scan: 'identity_check', identity: identity || null, origin: 'manual', manual: true })); }); }
